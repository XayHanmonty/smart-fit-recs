...
class QueryTowerFactory:
    ...
    def build(
        ...
        from recsys.training.two_tower import QueryTower # not a good way to do this, but will get back 
...
class ItemTowerFactory:
    ...
    def build(
        ...
        from recsys.training.two_tower import ItemTower # not a good way to do this, but will get back 
...
class TwoTowerFactory:
    ...
    def build(
        ...
        from recsys.training.two_tower import TwoTowerModel # not a good way to do this, but will get back 
